...
resourcename="lawson1"  # lower case, only
resourcegroup="lawson1_rg"
...
# git clone https://github.com/apilogicserver/lawson1.git
# cd lawson1
...
az group create --name lawson1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group lawson1_rg --sku S1 --is-linux
az container create --resource-group lawson1_rg --name lawson1 --image apilogicserver/lawson1:latest --dns-name-label lawson1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//lawson1.westus.azurecontainer.io:5656'
