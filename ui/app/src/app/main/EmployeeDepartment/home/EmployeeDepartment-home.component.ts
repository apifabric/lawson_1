...
@Component({
  selector: 'EmployeeDepartment-home',
  templateUrl: './EmployeeDepartment-home.component.html',
  styleUrls: ['./EmployeeDepartment-home.component.scss']
})
export class EmployeeDepartmentHomeComponent implements AfterViewInit {
