...
@Component({
  selector: 'SalesReport-home',
  templateUrl: './SalesReport-home.component.html',
  styleUrls: ['./SalesReport-home.component.scss']
})
export class SalesReportHomeComponent implements AfterViewInit {
